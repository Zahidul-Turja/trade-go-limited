...
function ApplicationsAndUsages({ applications, usages }) {
  ...
  return (
    <section className="mx-auto w-full px-5 py-6 md:py-medium lg:px-big">
      <div className="flex items-center justify-between overflow-hidden rounded-lg bg-gray-300/40 px-5 py-2">
        <button
...
function Applications({ applications }) {
  return (
    <div className="mx-auto mt-6 w-full rounded-lg border border-gray-200 px-small py-6 text-center shadow-sm">
